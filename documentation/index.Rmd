...
<img src="images/apple-touch-icon.png" class="cover" width="120" height="120"/> Questa è la versione 0.1 della **Documentazione** dedicata al progetto **Indicatore Zona Gialla** / **indicatore di stress**. La documentazione è tuttora in revisione, l'ultima data di rilascio è `r today()`. 
